...
- ✅ Automatic metadata update after rebase
...
#### Features
- ✅ AI assistance for rebase conflicts during sync
- ✅ Conflict detection and interactive prompt
- ✅ Context file with conflict summary
- ✅ Helpful hints when conflicts occur

## 🧪 Testing

**Both features thoroughly tested:**
- ✅ 6 comprehensive tests for change-base functionality
- ✅ 2 comprehensive tests for sync --ai-merge
- ✅ All tests pass on Ubuntu & macOS with Python 3.11 & 3.12
- ✅ CI passed for both features
...
**Benefits:**
- ✨ Core workflow commands are now prominently displayed at the top
- 📚 Related commands are grouped together logically
- 🎯 Easier for new users to understand the tool's capabilities
- 🔍 Deprecated commands are clearly separated
...
### Testing
- ✅ 15 comprehensive tests added in `tests/test_backup_restore.py`
- ✅ All tests passing across Ubuntu & macOS with Python 3.11 & 3.12
- ✅ Fixed pytest monkeypatch test interference issues
...
**Features:**
- 📤 **Export**: Create timestamped JSON exports with all worktree metadata
- 📥 **Import**: Preview changes before applying with safe restoration
- 🔄 **Cross-machine sync**: Share configurations across development environments
- 👥 **Team onboarding**: Standardize team worktree setups
